...
public class BPMN2View extends DefaultTreeProjector<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> {
    ...
    public TreeItem projectInstance(BPMN2RuntimeConfiguration configuration, List<CallActivity> callStack, String processName) {
    ...
    public TreeItem projectTokens(BPMN2RuntimeConfiguration configuration) {
    ...
    @Override
    public TreeItem projectConfiguration(BPMN2RuntimeConfiguration configuration) {
