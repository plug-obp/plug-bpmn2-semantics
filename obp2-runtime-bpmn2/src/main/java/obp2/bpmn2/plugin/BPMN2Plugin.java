...
public class BPMN2Plugin implements ILanguagePlugin<URI, BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> {
    ...
    @Override
    public Function<URI, ILanguageModule<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void>> languageModuleFunction() {
