...
public class BPMN2Evaluator implements IAtomicPropositionsEvaluator<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> {

    private final BPMN2ProcessedModel model;
    private ILanguageModule<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> module;
    ...
    @Override
    public boolean[] getAtomicPropositionValuations(BPMN2RuntimeConfiguration source, BPMN2FlowAction fireable, Void output, BPMN2RuntimeConfiguration target) {
