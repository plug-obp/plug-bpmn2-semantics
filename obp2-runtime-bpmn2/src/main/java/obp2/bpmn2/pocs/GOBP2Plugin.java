...
public class GOBP2Plugin {
    ...
    static public void main(String args[]) throws Exception {
        ...
        ILanguageModule<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> module = plugin.getLanguageModule(modelURI);

        IAtomicPropositionsEvaluator<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> evaluator = module.getAtomicPropositionEvaluator();
        evaluator.setModule(module);
        evaluator.registerAtomicPropositions(atomicPropositions);

        ITransitionRelation<BPMN2RuntimeConfiguration, BPMN2FlowAction, Void> transitionRelation = module.getTransitionRelation();
        Set<BPMN2RuntimeConfiguration> initials = transitionRelation.initialConfigurations();

        for (BPMN2RuntimeConfiguration initial : initials) {
